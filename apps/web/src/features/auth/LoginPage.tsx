    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-sm">Sign in to your LeadAnchor CRM</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link to="/reset-password" className="text-xs text-blue-400 hover:text-blue-300 font-medium transition-colors">
                Forgot password?
              </Link>
            </div>
            <div className="relative">
        ...
        <div className="mt-6 flex items-center gap-4">
          <div className="h-px flex-1" style={{ background: 'rgba(148,163,184,0.1)' }}></div>
        ...
        <button
          ...
          type="button"
          className="mt-6 w-full py-2.5 rounded-xl text-sm font-medium transition-all flex items-center justify-center gap-2 text-slate-300 hover:text-white"
          style={{
